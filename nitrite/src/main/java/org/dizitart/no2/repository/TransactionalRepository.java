...
import org.dizitart.no2.store.tx.Transactional;
 ...
 */
public interface TransactionalRepository<T> extends Transactional, PersistentCollection<T> {
    /**
    ...
    /**
     * Returns the type associated with the {@link org.dizitart.no2.repository.ObjectRepository}.
     *
     ...
     */
    TransactionalCollection getDocumentCollection();
}
