 ...
 */
public interface TransactionalCollection extends Transactional, PersistentCollection<Document> {
    /**
    ...
    /**
     * Returns the name of the {@link org.dizitart.no2.collection.NitriteCollection}.
     *
     * @return the name.
     */
    String getName();
