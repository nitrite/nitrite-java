...
public class ChangeDataTypeTest {
    ...
    public void testExecute() {
        ChangeDataType changeDataType = new ChangeDataType("Collection Name", "Field Name", mock(TypeConverter.class));
