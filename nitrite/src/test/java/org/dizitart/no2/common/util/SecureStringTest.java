...
public class SecureStringTest {
    ...
    public void testConstructor() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> new SecureString(1, 3,
            new SecureString(new SecureString(new SecureString(new SecureString(""))))));
        ...
        assertThrows(NegativeArraySizeException.class, () -> new SecureString(Integer.MIN_VALUE, 3,
            new SecureString(new SecureString(new SecureString(new SecureString(""))))));
        assertEquals(0,
            (new SecureString(new SecureString(new SecureString(new SecureString(new SecureString(""))))))
                .length());
        assertEquals(1,
            (new SecureString(new SecureString(new SecureString(new SecureString(new SecureString(String.valueOf('A')))))))
                .length());
        assertEquals(0, (new SecureString("")).length());
    ...
    public void testCharAt2() {
        assertEquals('o',
            (new SecureString(new SecureString(new SecureString(new SecureString("foo"))))).charAt(1));
    }
    ...
    public void testLength() {
        assertEquals(0, (new SecureString(new SecureString(new SecureString(new SecureString(""))))).length());
        assertEquals(0, (new SecureString(new SecureString(new SecureString(new SecureString(""))))).length());
    }
    ...
    public void testSubSequence2() {
        assertEquals(2,
            (new SecureString(new SecureString(new SecureString(new SecureString("foo"))))).subSequence(1, 3)
                .length());
    }
    ...
    public void testAsString() {
        assertEquals("", (new SecureString(new SecureString(new SecureString(new SecureString(""))))).asString());
        assertEquals("A",
    ...
    public void testToString() {
        assertEquals("Secure:XXXXX",
            (new SecureString(new SecureString(new SecureString(new SecureString(""))))).toString());
        assertEquals("Secure:XXXXX",
            (new SecureString(new SecureString(new SecureString(new SecureString(""))))).toString());
    }
}
