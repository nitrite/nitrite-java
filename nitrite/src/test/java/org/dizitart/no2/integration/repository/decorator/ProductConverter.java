...
public class ProductConverter implements EntityConverter<Product> {
    ...
    public Document toDocument(Product entity, NitriteMapper nitriteMapper) {
        Document productId = nitriteMapper.convert(entity.getProductId(), Document.class);
        Document manufacturer = nitriteMapper.convert(entity.getManufacturer(), Document.class);
    ...
    public Product fromDocument(Document document, NitriteMapper nitriteMapper) {
        ...
        ProductId productId = nitriteMapper.convert(document.get("productId", Document.class), ProductId.class);
        Manufacturer manufacturer = nitriteMapper.convert(document.get("manufacturer", Document.class),
            Manufacturer.class);
