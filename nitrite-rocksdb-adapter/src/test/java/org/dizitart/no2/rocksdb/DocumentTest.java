...
public class DocumentTest {
    ...
    public void testGetValue() {
        ...
        Assert.assertEquals(doc.get("location.address"), TestUtil.parse("{" +
            "            line1: '40', " +
            "            line2: 'ABC Street', " +
            "            house: ['1', '2', '3'] " +
            "       },"));
        ...
        Assert.assertNotEquals(doc.get("location.address.test"), TestUtil.parse("{" +
            "            line1: '40', " +
            "            line2: 'ABC Street'" +
            "       },"));
    ...
    public void testEquals() {
        Document doc1 = createDocument("first", new String[] { "a", "b" })
            .put("second", createDocument("third", 1))
            .put("fourth", "fourth");

        Document doc2 = createDocument("first", new String[] { "a", "b" })
            .put("second", createDocument("third", 1))
            .put("fourth", "fourth");

        assertEquals(doc1, doc2);

        Document doc3 = createDocument("first", new String[] { "b", "a" })
            .put("second", createDocument("third", 1))
            .put("fourth", "fourth");
