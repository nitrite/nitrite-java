...
public class CollectionInsertTest extends BaseTransactionTest {

    @Test
    public void testInsert() {
        WriteResult result = txCollection.insert(doc1, doc2, doc3);
    ...
    public void testInsertHeteroDocs() {
        ...
        WriteResult result = txCollection.insert(doc1, doc2, doc3, document);
