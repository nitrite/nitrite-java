...
public class NitriteBuilderTest {
    ...
    public void testConfig() throws IOException {
        ...
        MapDBConfig storeConfig = (MapDBConfig) db.getStore().getStoreConfig();
        ...
        builder = MapDBModule.withConfig()
            .readOnly(true)
            .filePath(filePath);

        db = Nitrite.builder().loadModule(builder.build()).openOrCreate();

        storeConfig = (MapDBConfig) db.getStore().getStoreConfig();
    ...
    public void testPopulateRepositories() {
        File file = new File(filePath);
        MapDBModule module = MapDBModule.withConfig().filePath(file).build();
        db = Nitrite.builder()
            .fieldSeparator(".")
            .loadModule(module)
            .openOrCreate();
