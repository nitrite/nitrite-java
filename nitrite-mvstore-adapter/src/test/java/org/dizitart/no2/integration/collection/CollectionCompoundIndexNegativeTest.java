...
public class CollectionCompoundIndexNegativeTest extends BaseCollectionTest {
    ...
    public void testIndexAlreadyExists() {
        ...
        collection.createIndex(indexOptions(IndexType.NON_UNIQUE), "firstName", "lastName");
    }

    @Test(expected = IndexingException.class)
    public void testCreateCompoundTextIndex() {
        collection.createIndex(indexOptions(IndexType.FULL_TEXT), "body", "lastName");
    }

    @Test(expected = IndexingException.class)
    public void testCreateMultiKeyIndexSecondField() {
        collection.createIndex(indexOptions(IndexType.NON_UNIQUE), "lastName", "data");
